...
*/
function eliminarFila(idlibro)
{

	bootbox.confirm("¿Está Seguro de eliminar el Libro?", function(result)
	{ // confirmamos con una pregunta si queremos eliminar
        if(result)
        {
            $.post("../ajax/libro.php?op=eliminar", {idlibro : idlibro}, function(e)
            {
	            bootbox.alert(e);
	            tabla.ajax.reload();
            });
